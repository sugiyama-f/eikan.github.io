捕一三：ミート60→走力60→守備D→ミート75<br/>
二遊：守備D→ミート60→走力60→守備C<br/>
外：走力60→ミート60→走力70(盗塁が低い場合は80まで上げる)→ミート75<br/>
盗塁C以上(捕一三)：走力60→ミート60→走力70(盗塁が低い場合は80まで上げる)→ミート75<br/>
盗塁C以上(二遊)：守備D→走力70→ミート60→守備C<br/>
